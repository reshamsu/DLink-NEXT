...
const Analytics = () => {
  return (
    <div className="bg-orange-400/15 text-black">
      <div className="max-w-7xl mx-auto rounded-3xl py-14 px-6 2xl:px-0">
        <div className="mb-12 px-2 text-center">
          <p className="text-[#f09712] text-lg font-extrabold">SERVICE</p>
          <h1 className="text-3xl md:text-4xl font-extrabold my-3">Our Expertise</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-4 lg:gap-8">
          {cardData.map((card, index) => (
            ...
            >
              <div className="w-24 h-24 mb-4 flex items-center justify-center bg-[#f09712] rounded-full shadow-inner hover:scale-100 transition-transform relative">
                <Image
                  src={card.icon}
                  alt={card.title}
                  width={80}
