  ...
  return (
    <>
      <div className="bg-gray-200 text-gray-900 relative">
        <div className="absolute -mt-40 inset-0 h-[74vh] w-full transition-opacity duration-1000 bg-gray-100">
          <Image
        ...
        <div className="max-w-6xl mx-auto">
          <div className="relative h-[74vh] inset-0 flex flex-col justify-center items-center text-center text-white z-10 pt-22 gap-14 px-6 md:px-20 lg:px-40">
            <div className="flex flex-col gap-4">
              <h1 className="text-3xl md:text-4xl 2xl:text-5xl font-extrabold flex flex-col md:flex-row gap-2 md:gap-2.5">
                Find your Next{" "}
                <ReactTyped
                  className="text-3xl md:text-4xl 2xl:text-5xl font-extrabold text-[#F28C38]"
            ...
            <form
              method="post"
              className=" bg-white text-gray-900 text-[15px] p-2 rounded-3xl md:rounded-full shadow-xl hover:scale-105 duration-1000 w-full flex flex-col justify-between lg:flex-row"
            >
