    ...
    <section className="bg-gray-100 text-gray-800" id="listings">
      <div className="max-w-6xl mx-auto flex flex-col gap-8 py-16 px-8 2xl:px-0">
        <div className="flex flex-col gap-3">
          ...
          <h1 className="text-xl font-extrabold">Featured Commercial Properties</h1>
        </div>
            ...
            {visibleListings.map((listing, index) => (
              ...
              >
                ...
                <div className="relative h-60 overflow-hidden rounded-tl-3xl">
                  ...
                  <span className="absolute top-3 left-3 bg-white backdrop-blur-sm border border-white/25 text-[10px] text-blue-600 font-bold px-2.5 py-1 rounded-full">
