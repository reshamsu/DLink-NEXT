      ...
      <div className="max-w-6xl mx-auto py-20 px-6 2xl:px-0">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center mb-8 gap-4 text-center md:text-start">
          <div>
            ...
            <h1 className="text-2xl font-bold">Featured Houses</h1>
          </div>
        </div>
        ...
        {loading ? (
          ...
          <p className="text-center text-gray-500 py-20">No houses found.</p>
        ) : (
          <motion.div
                ...
                <div className="flex flex-col gap-2.5 pt-4 pb-1.5 px-2">
                  <div>
                    <Link
                      ...
                      onClick={scrollToTop}
                      className="text-sm font-bold hover:text-orange-400 capitalize line-clamp-1"
                    >
                      {listing.title}
                    </Link>
