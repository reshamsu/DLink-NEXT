...
const Hero = () => {
  return (
    <div className="bg-gradient-to-b from-blue-600/20 via-[#ffffff] to-[#ffffff] text-gray-800 relative">
      <div className="max-w-6xl mx-auto py-16 px-6 2xl:px-0 flex flex-col gap-8">
        ...
        <div className="flex flex-col items-center text-center gap-8">
          <h6 className="text-sm md:text-base 2xl:text-lg max-w-2xl lg:max-w-3xl 2xl:max-w-4xl text-gray-800 leading-relaxed">
            <i className="text-blue-600 font-extrabold">D-Link Colombo</i> is
            ...
            infrastructure,{" "}
            <i className="text-blue-600 font-extrabold">
              D-Link Colombo
            </i>{" "}
