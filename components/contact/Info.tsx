...
const Info = () => {
  return (
    <div className="bg-linear-to-b from-[#ffffff] via-[#ffffff] to-orange-500/10 text-gray-700">
      <div className="max-w-6xl mx-auto py-14 md:py-20 px-8 md:px-10 2xl:px-0">
        <div className="flex flex-col justify-center gap-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 text-[15px]">
            {/* PHONE */}
            <div className="bg-orange-500/5 border-4 border-orange-600/60 hover:bg-teal-600/20 hover:border-teal-600/60 p-7 flex flex-col items-start justify-center gap-4 rounded-4xl hover:scale-105 duration-1000 group shadow-lg">
              <div className="p-3 bg-orange-500/10 group-hover:bg-white/40 duration-700 rounded-2xl shadow-sm w-fit">
                <TbPhone size={30} className="text-3xl text-orange-500 group-hover:text-teal-600 transition-all" />
              </div>
              <label
                htmlFor="
              "
            ...
            {/* EMAIL */}
            <div className="bg-orange-500/5 border-4 border-orange-600/60 hover:bg-teal-600/20 hover:border-orange-600/60 p-7 flex flex-col items-start justify-center gap-4 rounded-4xl hover:scale-105 duration-1000 group shadow-lg">
              <div className="p-3 bg-orange-500/10 group-hover:bg-white/40 duration-700 rounded-2xl shadow-sm w-fit">
